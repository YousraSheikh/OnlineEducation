...
const ContactUs = () => {
  return (
    ...
    <h2 className='text-blue font-bold mt-7 text-[30px] text-center'>
       ...
       <div className='flex lg:flex-row flex-col gap-5  w-auto  mx-20 mt-7'>
        ...
        <div className='flex flex-row'>
            <FiHeadphones className='p-3 rounded-full text-blue bg-sky-300 w-14 h-14 mt-1'/>
        ...
        <div className='mt-7 flex flex-row'>
            <AiOutlineMail className='p-3 rounded-full text-blue bg-sky-300 w-14 h-14 mt-1'/>
        <h2 className='font-bold block text-[20px] ml-5 mt-3'>Email us</h2>
        </div>
        <div className='block ml-14'>support@gmail.com</div>
        </div>  <div className='flex flex-col'>
        <div className='mt-7 flex flex-row'>
            <GrLocation className='p-3 rounded-full text-blue bg-sky-300 w-14 h-14 mt-1'/>
